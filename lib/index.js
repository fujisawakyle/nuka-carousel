    ...
    value: function getMouseEvents() {
      ...
      return {
        ...
        onMouseMove: function onMouseMove(e) {
          ...
          var direction = _this2.swipeDirection(_this2.touchObject.startX, e.clientX, _this2.touchObject.startY, e.clientY);

          if (direction !== 0) {
            e.preventDefault();
          }

          var length = _this2.props.vertical ? Math.round(Math.sqrt(Math.pow(e.clientY - _this2.touchObject.startY, 2))) : Math.round(Math.sqrt(Math.pow(e.clientX - _this2.touchObject.startX, 2)));
          _this2.touchObject = {
      ...
      if (index >= _react.default.Children.count(this.props.children) || index < 0) {
        ...
        if (index >= _react.default.Children.count(this.props.children)) {
          ...
          this.setState(function (prevState) {
            return {
              left: _this3.props.vertical ? 0 : _this3.getTargetLeft(-1, prevState.currentSlide),
              top: _this3.props.vertical ? _this3.getTargetLeft(-1, prevState.currentSlide) : 0,
    ...
    value: function renderControls() {
      ...
      return this.controlsMap.map(function (_ref) {
        ...
        return func && typeof func === 'function' && _react.default.createElement("div", {
          ...
          slidesToShow: _this7.props.slidesToShow,
      ...
      return _react.default.createElement("div", {
        ...
        children: function children(_ref2) {
          ...
          return _react.default.createElement("div", _extends({
            ...
            style: _this8.getFrameStyles()
          }, _this8.getTouchEvents(), _this8.getMouseEvents(), {
            onClick: _this8.handleClick
          }), _react.default.createElement("ul", {
            className: "slider-list",
            style: _this8.getListStyles({
              tx: tx,
              ty: ty
            })
          }, _children));
