...
var Carousel = (0, _createReactClass2.default)({
  ...
  propTypes: {
    ...
    decorators: _propTypes2.default.arrayOf(
    ...
    slidesToScroll: _propTypes2.default.oneOfType([
      _propTypes2.default.number,
      _propTypes2.default.oneOf(['auto'])
    ]),
    slideWidth: _propTypes2.default.oneOfType([
  ...
  render: function render() {
    var self = this;
    var children =
      _react2.default.Children.count(this.props.children) > 1
    ...
    if (this.touchObject.length > this.state.slideWidth / slidesToShow / 5) {
      if (this.touchObject.direction === 1) {
        if (
          ...
          this.animateSlide(
            _reactTweenState2.default.easingTypes[this.props.edgeEasing]
          );
        } else {
          this.nextSlide();
        }
  ...
  goToSlide: function goToSlide(index) {
    var self = this;
    if (
      index >= _react2.default.Children.count(this.props.children) ||
      index < 0
    ) {
      if (!this.props.wrapAround) {
        return;
  ...
  getSlideTargetPosition: function getSlideTargetPosition(
    index,
    positionValue
  ) {
